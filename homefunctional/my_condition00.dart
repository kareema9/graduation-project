...
class MyCondition00 extends StatefulWidget {
  const MyCondition00({super.key});

  @override
  State<MyCondition00> createState() => _MyCondition();
}

class _MyCondition extends State<MyCondition00> {
  int? stageSystem;
  int? stageCaregiver;
  int? stageDoctor;
  int? stage;
              ...
              children: [
                ...
                Card(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image.asset("images/iconAD.png", width: 45, height: 45),
