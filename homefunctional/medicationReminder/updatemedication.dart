...
class Updatemedication extends StatefulWidget {
  ...
  const Updatemedication({super.key, this.medicationDoc});

  @override
  State<Updatemedication> createState() => _Updatemedication();
}

class _Updatemedication extends State<Updatemedication> {
  ...
  Future<void> pickTime(BuildContext context) async {
    ...
    if (pickedTime != null) {
      setState(() {
        ...
        // إذا الوقت اختير وكان ماضي => خليه لبكرا
                    ...
                    onPressed: () async {
                      ...
                      try {
                        ...
                        await NotficationMedication.scheduleMedicationNotification(
                          ...
                          // dateTime: selectedDateTime!,
                          days: selectedDays, //  القائمة اللي اختارها المستخدم
                        );
