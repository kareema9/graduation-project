...
import 'package:first_app/evaluation/lev_three.dart';
import 'package:first_app/navbar/navigator_page.dart';
import 'package:flutter/material.dart';

class LevTwo extends StatefulWidget {
  @override
  _LevTwo createState() => _LevTwo();
}

class _LevTwo extends State<LevTwo> {
  ...
  void submit() async {
    ...
    if (score > 24) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (_) => LevThree()),
      );
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
