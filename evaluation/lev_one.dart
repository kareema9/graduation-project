...
import 'package:first_app/evaluation/lev_two.dart';
import 'package:first_app/navbar/navigator_page.dart';
import 'package:flutter/material.dart';

class LevOne extends StatefulWidget {
  @override
  _LevOne createState() => _LevOne();
}

class _LevOne extends State<LevOne> {
  ...
  void submit() async {
    ...
    if (score > 24) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (_) => LevTwo()),
      );
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
